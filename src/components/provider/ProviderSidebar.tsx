import { Home, Inbox, BarChart3, Wallet, Calendar, Settings, ChevronLeft, LogOut, LayoutDashboard, Building2, CreditCard } from "lucide-react";
...
const mainItems = [
  ...
  { title: "Bookings", url: "/provider/calendar", icon: Calendar },
];
